        ...
        for (std::size_t b = 0 ; b < lutSize - 1 ; ++b) {
            for (std::size_t g = 0 ; g < lutSize - 1 ; ++g) {
                for (std::size_t r = 0 ; r < lutSize - 1 ; ++r) {
                    ...
                    cube.outVerts = {
                        lut.table.at(r, g, b),
                        lut.table.at(r + 1, g, b),
                        lut.table.at(r, g + 1, b),
                        lut.table.at(r + 1, g + 1, b),
                        lut.table.at(r, g, b + 1),
                        lut.table.at(r + 1, g, b + 1),
                        lut.table.at(r, g + 1, b + 1),
                        lut.table.at(r + 1, g + 1, b + 1)
                    };
                }
            }
        }
